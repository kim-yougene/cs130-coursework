...
document.querySelector('button#ch1').onclick = chapter1;
document.querySelector('button#ch2').onclick = chapter2;
document.querySelector('button#ch3').onclick = chapter3;
